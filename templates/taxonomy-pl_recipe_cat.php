<?php
/**
 * Template for displaying recipe category taxonomy
 *
...
<main id="recipe-archive-main" class="recipe-archive-wrapper">
	<header class="archive-header">
		<div class="archive-title-wrapper">
			...
			<div class="archive-title-content">
				<span class="archive-label"><?php esc_html_e( 'Category', 'pl-recipe-cookbook' ); ?></span>
	...
	<?php else : ?>
		<div class="no-recipes">
			<p><?php esc_html_e( 'No recipes found in this category.', 'pl-recipe-cookbook' ); ?></p>
		</div>
	<?php endif; ?>
</main>
