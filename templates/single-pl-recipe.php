			...
			<div class="recipe-hero-section">
				...
				?>
					<div class="recipe-featured-image">
						<button type="button" class="recipe-image-expand" 
							aria-label="<?php esc_attr_e( 'Expand image', 'pl-recipe-cookbook' ); ?>"
							data-full-image="<?php echo esc_url( $image_full[0] ); ?>"
							data-image-alt="<?php echo esc_attr( $image_alt ? $image_alt : get_the_title() ); ?>">
...
<!-- Lightbox Modal (Outside all containers for proper z-index layering) -->
<div class="recipe-image-lightbox" role="dialog" aria-modal="true" aria-label="<?php esc_attr_e( 'Image lightbox', 'pl-recipe-cookbook' ); ?>">
	<button type="button" class="lightbox-close" aria-label="<?php esc_attr_e( 'Close lightbox', 'pl-recipe-cookbook' ); ?>">
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
